...
public class MemberController {
	...
	public ModelAndView find_id_ok(String mem_name, String phone02, HttpServletResponse response, MemberDTO e)
			throws Exception {
	...
	public ModelAndView find_pwd_ok(String mem_name, String mem_id, HttpServletResponse response, MemberDTO t)
			throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
	...
	public String login_ok(String mem_id, String mem_pwd, HttpSession session, HttpServletResponse response)
			throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
...
//			if(!md.getMem_pwd().equals(md.getMem_pwd())){
	...
	public ModelAndView mypage(HttpServletResponse response, HttpSession session) throws Exception {
		...
		if (id == null) {
			...
			av.addObject("m", ym);// m키이름에 ym객체를 저장
	...
	public ModelAndView pwd_change(HttpServletResponse response, HttpSession session) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		String id = (String) session.getAttribute("id");// 세션 아이디값을 구함
	...
	public String pwd_change_ok(HttpSession session, HttpServletResponse response, MemberDTO m, String mem_id)
			throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
	...
	public String member_edit_ok(MemberDTO em, HttpServletResponse response, HttpSession session) throws Exception {
	...
	public String member_del_ok(HttpServletResponse response, HttpSession session, MemberDTO bm, String mem_id,
			String mem_pwd) throws Exception {
	...
	public String charge(HttpSession session, HttpServletResponse response, HttpServletRequest request, Model m,
			CashDTO cash) throws IOException {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
	...
	public String my_history(HttpServletResponse response, HttpSession session, Model m, Social_historyDTO sh)
			throws Exception {
	...
	public String cash_history(HttpSession session, HttpServletResponse response, CashDTO cash, Model m)
			throws IOException {
